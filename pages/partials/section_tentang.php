                ...
                <div class="col-lg-6 ps-lg-5" data-aos="fade-left">
                    ...
                    <div class="row mt-4">
                        <div class="col-sm-6 mb-3">
                            <a href="pages/certification.php" class="text-decoration-none d-flex align-items-center p-3 rounded-4 transition-all bg-white shadow-sm border border-info border-opacity-10 hover-button-premium">
                        ...
                        <div class="col-sm-6 mb-3">
                            <a href="pages/examiners.php" class="text-decoration-none d-flex align-items-center p-3 rounded-4 transition-all bg-white shadow-sm border border-info border-opacity-10 hover-button-premium">
                                <div class="bg-info bg-opacity-10 p-3 rounded-circle me-3 text-info">
