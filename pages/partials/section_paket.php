                ...
                <div class="swiper paketSwiper">
                    <div class="swiper-wrapper">
                        <?php foreach ($classItems as $c): 
                            ...
                            $detailUrl = 'pages/class_detail.php?id=' . (int)$c['id'] . '&from=landing';
                        ?>
                        <div class="swiper-slide d-flex align-items-stretch">
                            <div class="paket-card w-100 border-0 rounded-4 bg-white d-flex flex-column"
                                ...
                                <div class="paket-card-content p-4 d-flex flex-column flex-grow-1 bg-white" style="border-bottom-left-radius: 1.25rem; border-bottom-right-radius: 1.25rem;">
                                    <h4 class="fw-bold mb-2 text-dark hover-primary text-truncate" style="font-size: 1.2rem;" title="<?php echo htmlspecialchars($c['name']); ?>"><?php echo htmlspecialchars($c['name']); ?></h4>
                                    <div class="mb-3">
                                    ...
                                    if ($ma2 === 'online') {
                                        echo '<small class="text-muted d-block" style="font-size:0.72rem;">Investasi Program</small><h5 class="text-primary fw-bold mb-0" style="font-size:1.1rem;">Rp '.number_format($pOn2,0,',','.').'</h5><small class="text-muted mt-1" style="font-size:0.7rem;"><span class="badge bg-info bg-opacity-10 text-info" style="font-size:0.68rem;"><i class="fas fa-laptop me-1"></i>Online</span></small>';
                                    } elseif ($ma2 === 'offline') {
                                        echo '<small class="text-muted d-block" style="font-size:0.72rem;">Investasi Program</small><h5 class="text-primary fw-bold mb-0" style="font-size:1.1rem;">Rp '.number_format($pOff2,0,',','.').'</h5><small class="text-muted mt-1" style="font-size:0.7rem;"><span class="badge bg-success bg-opacity-10 text-success" style="font-size:0.68rem;"><i class="fas fa-chalkboard-teacher me-1"></i>Offline</span></small>';
                                    } else {
                                        if ($pOn2 !== $pOff2) {
                                            echo '<small class="text-muted d-block" style="font-size:0.72rem;">Mulai dari</small><h5 class="text-primary fw-bold mb-0" style="font-size:1.1rem;">Rp '.number_format(min($pOn2,$pOff2),0,',','.').'</h5><small class="text-muted mt-1" style="font-size:0.7rem;">Offline Rp '.number_format($pOff2,0,',','.').' &bull; Online Rp '.number_format($pOn2,0,',','.').'</small>';
                                        } else {
                                            echo '<small class="text-muted d-block" style="font-size:0.72rem;">Investasi Program</small><h5 class="text-primary fw-bold mb-0" style="font-size:1.1rem;">Rp '.number_format($pLegacy2,0,',','.').'</h5><small class="text-muted mt-1" style="font-size:0.7rem;">Online &bull; Offline</small>';
                                        }
                                    }
                                    ?>
                                    </div>
                                    ...
                                    <div class="mb-3 d-flex flex-column justify-content-start" style="min-height: 84px;">
                                        <?php 
                                        $fList = array_slice($featuresArr, 0, 3);
                                        foreach ($fList as $f): ?>
                                    ...
                                    <div class="mt-auto pt-3 pb-2">
                                        <a href="<?php echo $detailUrl; ?>" class="btn btn-primary btn-premium w-100 py-3 rounded-pill fw-bold shadow-sm d-block text-center" 
