<!-- DASHBOARD HOME -->
        ...
        <div class="row g-4 mb-5">
            <div class="col-md-3" data-aos="fade-up" data-aos-delay="100">
                <div class="card border-0 shadow-sm h-100 position-relative overflow-hidden" style="background: linear-gradient(135deg, #064e3b, #059669); color: white;">
                    <div class="card-body p-4 position-relative z-1">
                        <div class="bg-white bg-opacity-25 rounded-3 p-2 d-inline-block mb-3">
                            <i class="fas fa-coins fs-4"></i>
                        </div>
                        <h4 class="fw-bold mb-1">Rp <?php echo number_format($stats['revenue'], 0, ',', '.'); ?></h4>
                        <div class="small fw-bold text-white-50 text-uppercase">Omzet Lunas</div>
                    </div>
                    <i class="fas fa-coins position-absolute opacity-10 float-icon" style="font-size: 7rem; right: -20px; bottom: -20px;"></i>
                </div>
            </div>
            <div class="col-md-3" data-aos="fade-up" data-aos-delay="200">
                <div class="card border-0 shadow-sm h-100 position-relative overflow-hidden" style="background: linear-gradient(135deg, #0e7490, #06b6d4); color: white;">
                    <div class="card-body p-4 position-relative z-1">
                        <div class="bg-white bg-opacity-25 rounded-3 p-2 d-inline-block mb-3">
                            <i class="fas fa-check-circle fs-4"></i>
                        </div>
                        <h2 class="fw-bold mb-1 counter-value" data-target="<?php echo $stats['paid_orders']; ?>">0</h2>
                        <div class="small fw-bold text-white-50 text-uppercase">Pesanan Lunas</div>
                    </div>
                    <i class="fas fa-check-circle position-absolute opacity-10 float-icon" style="font-size: 7rem; right: -20px; bottom: -20px; animation-delay: 1s;"></i>
                </div>
            </div>
            <div class="col-md-3" data-aos="fade-up" data-aos-delay="300">
                <div class="card border-0 shadow-sm h-100 position-relative overflow-hidden" style="background: linear-gradient(135deg, #92400e, #f59e0b); color: white;">
                    <div class="card-body p-4 position-relative z-1">
                        <div class="bg-white bg-opacity-25 rounded-3 p-2 d-inline-block mb-3">
                            <i class="fas fa-hourglass-half fs-4"></i>
                        </div>
                        <h2 class="fw-bold mb-1 counter-value" data-target="<?php echo $stats['waiting_payment']; ?>">0</h2>
                        <div class="small fw-bold text-white-50 text-uppercase">Menunggu Bayar</div>
                    </div>
                    <i class="fas fa-hourglass-half position-absolute opacity-10 float-icon" style="font-size: 7rem; right: -20px; bottom: -20px; animation-delay: 2s;"></i>
                </div>
            </div>
            <div class="col-md-3" data-aos="fade-up" data-aos-delay="400">
                <div class="card border-0 shadow-sm h-100 position-relative overflow-hidden" style="background: linear-gradient(135deg, #991b1b, #ef4444); color: white;">
                    <div class="card-body p-4 position-relative z-1">
                        <div class="bg-white bg-opacity-25 rounded-3 p-2 d-inline-block mb-3">
                            <i class="fas fa-ban fs-4"></i>
                        </div>
                        <h2 class="fw-bold mb-1 counter-value" data-target="<?php echo $stats['failed_orders']; ?>">0</h2>
                        <div class="small fw-bold text-white-50 text-uppercase">Gagal / Kadaluarsa</div>
                    </div>
                    <i class="fas fa-ban position-absolute opacity-10 float-icon" style="font-size: 7rem; right: -20px; bottom: -20px; animation-delay: 3s;"></i>
                </div>
            </div>
        </div>
